...
public class XMLParser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _reduce_table = 
    ...
    "\004\007\260\001\001\000\002\001\001\000\006\017\022" +
    "\021\262\001\001\000\004\007\263\001\001\000\002\001" +
    "\001\000\010\015\265\017\223\023\226\001\001\000\004" +
    "\007\266\001\001\000\002\001\001\000\002\001\001\000" +
    "\002\001\001\000\002\001\001\000\010\004\275\005\273" +
    "\006\010\001\001\000\002\001\001\000\002\001\001\000" +
    "\006\005\276\006\010\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\002\001\001\000\002\001" +
    "\001\000\002\001\001\000\002\001\001\000\006\005\276" +
    "\006\010\001\001\000\002\001\001\000\002\001\001\000" +
    "\002\001\001" });
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$XMLParser$act_num)
		...
		ArrayList<Parameter> listP = (ArrayList<Parameter>)((java_cup.runtime.Symbol) CUP$XMLParser$stack.elementAt(CUP$XMLParser$top-1)).value;
            ...
            if(valid) actions.createSite(listP);
		...
		ArrayList<Parameter> listP = (ArrayList<Parameter>)((java_cup.runtime.Symbol) CUP$XMLParser$stack.elementAt(CUP$XMLParser$top-1)).value;
            ...
            if(valid) actions.deleteSite(listP);
		...
		ArrayList<Parameter> listP = (ArrayList<Parameter>)((java_cup.runtime.Symbol) CUP$XMLParser$stack.elementAt(CUP$XMLParser$top-1)).value;
            ...
            if(valid) actions.deletePage(listP);
		...
		ActionPA a = (ActionPA)((java_cup.runtime.Symbol) CUP$XMLParser$stack.elementAt(CUP$XMLParser$top-1)).value;
            ...
            if(valid) actions.createComponent(a);
		...
		ArrayList<Parameter> listP = (ArrayList<Parameter>)((java_cup.runtime.Symbol) CUP$XMLParser$stack.elementAt(CUP$XMLParser$top-1)).value;
            ...
            if(valid) actions.deleteComponent(listP);
		...
		ActionPA a = (ActionPA)((java_cup.runtime.Symbol) CUP$XMLParser$stack.elementAt(CUP$XMLParser$top-1)).value;
            ...
            if(valid) actions.editComponent(a);
